...
class CartView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        free_shipping_limit = 500000
        remaining_for_free_shipping = max(free_shipping_limit - cart.total_price, 0)
        
        context['cart'] = cart
        context['free_shipping_limit'] = free_shipping_limit
        context['remaining_for_free_shipping'] = remaining_for_free_shipping
